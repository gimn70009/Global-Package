...
public class GlobalExceptionHandler {
    // @RequestBody로 받은 객체에 @Valid 또는 @Validated를 적용했을 때
    ...
    // @RequestParam, @ModelAttribute로 받은 객체에 @Valid 또는 @Validated를 적용했을 때
    // 선언된 검증 조건 위반 시 발생
    ...
    // @RequestBody등으로 전달받은 JSON 바디의 파싱이 실패했을 때 (JSON 문법 오류, 타입 불일치, 필수 바디 없음 등)
